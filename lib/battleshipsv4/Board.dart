...
import 'package:testproject/battleshipsv4/FailedToPlaceShipException.dart';
import 'package:testproject/battleshipsv4/Fleet.dart';
import 'package:testproject/battleshipsv4/Ship.dart';
import 'package:testproject/battleshipsv4/Square.dart';
    ...
    if (square.isTried() == false) {
      ...
      if (square.isHit()) {
        if (square.getShip()!.isSunk()) {
          print("${square.getShip()!.getName()!} is SUNK!");
          return true;
        } else {
          return false;
        }
